...
The application was vulnerable to SQL injection through the `category` parameter. Since the query results were returned in the application's response, I could use `UNION SELECT` to test how many columns the original query contained.
